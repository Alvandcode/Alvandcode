...
- Currently working on: <!-- WORKING-ON:START -->**AndroidSecurityScanner (Kotlin)** and **qand-app (Dart)**<!-- WORKING-ON:END -->
...
- در حال کار روی: <!-- WORKING-ON-FA:START -->**AndroidSecurityScanner (کاتلین)** و **qand-app (دارت)**<!-- WORKING-ON-FA:END -->
