...
- Currently working on: <!-- WORKING-ON:START -->**StegaSuite (Kotlin)** and **ocr-stt-tool (Python)**<!-- WORKING-ON:END -->
...
- در حال کار روی: <!-- WORKING-ON-FA:START -->**StegaSuite (کاتلین)** و **ocr-stt-tool (پایتون)**<!-- WORKING-ON-FA:END -->
